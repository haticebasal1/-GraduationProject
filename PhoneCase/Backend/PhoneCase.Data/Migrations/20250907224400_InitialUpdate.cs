    ...
    public partial class InitialUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "030acc04-b2c4-4887-9085-e37fd9f498b7", null, "Admin", "ADMIN" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7dd21677-49a5-4d13-9006-dc909993c4b9", 0, "Ataköy", null, "İstanbul", "da12aa8f-3dfb-4966-aefe-3a5533d4810a", "testuser@example.com", true, "Alp", 2, "Kaya", false, null, "TESTUSER@EXAMPLE.COM", "TESTUSER", "AQAAAAIAAYagAAAAEDzNDsqNUzz9elAdq+ay+MwoG2DSASH1haz+WvJ1PTRr0TtaFtf2i/onOBAqlchw4g==", null, false, new DateTimeOffset(new DateTime(2025, 9, 7, 22, 44, 0, 690, DateTimeKind.Unspecified).AddTicks(3540), new TimeSpan(0, 0, 0, 0, 0)), "e91c3fd3-4877-4f88-8e50-575e7c946e0f", false, "testuser" },
                    { "9309f4e0-4338-4af3-bf2b-fb9b1a2061f7", 0, "Bakırköy", null, "İstanbul", "5009e8df-f86d-44b9-85b0-455cd2902253", "testadmin@example.com", true, "Defne", 1, "Yalçın", false, null, "TESTADMIN@EXAMPLE.COM", "TESTADMIN", "AQAAAAIAAYagAAAAEOvcHZ9MO2K1v/G4NeppuAeiZ8DkcWAFVMRjmt78+wFmAmDZYeJ/T0WA7UxbAjn6SA==", null, false, new DateTimeOffset(new DateTime(2025, 9, 7, 22, 44, 0, 654, DateTimeKind.Unspecified).AddTicks(4590), new TimeSpan(0, 0, 0, 0, 0)), "d6a4d100-6ad2-40cd-8d95-f6be5fd439c0", false, "testadmin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2025, 9, 7, 22, 44, 0, 725, DateTimeKind.Unspecified).AddTicks(3530), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), false, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "9309f4e0-4338-4af3-bf2b-fb9b1a2061f7" },
                    { 2, new DateTimeOffset(new DateTime(2025, 9, 7, 22, 44, 0, 725, DateTimeKind.Unspecified).AddTicks(3530), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), false, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "7dd21677-49a5-4d13-9006-dc909993c4b9" }
                });
